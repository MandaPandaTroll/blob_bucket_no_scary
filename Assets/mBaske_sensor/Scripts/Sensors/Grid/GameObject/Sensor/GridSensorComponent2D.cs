...
namespace MBaske.Sensors.Grid
{
    ...
    public class GridSensorComponent2D : GridSensorComponentBaseGO
    {
        ...
        private Bounds m_DetectionBounds = new Bounds(Vector3.zero, new Vector3(20, 20, 1));
        ...
        [SerializeField, HideInInspector]
        private Bounds m_EditorBounds = new Bounds(Vector3.zero, new Vector3(20, 20, 1));
        ...
        private Vector3Int m_NumCells = new Vector3Int(20, 20, 1);
        ...
        private void OnNumCellsChange()
        {
            ...
            if (n != m_NumCells)
            {
                ...
                // Resize, fit x/y to cells.
                Vector3 size = (Vector3)m_NumCells * m_CellSize;
                size.z = b.size.z; // keep height
                b.size = size;
            }
            EditorBounds = b;
        }
        ...
        private Vector3 m_DetectionSize = new Vector3(20, 20, 1);
        ...
        private Vector3 m_BoundsSize = new Vector3(20, 20, 1);
        ...
        private void OnBoundsSizeChange()
        {
            ...
            b.size = new Vector3(
                ...
                Mathf.Max(m_BoundsSize.y, m_CellSize),
                Mathf.Max(m_BoundsSize.z, 1));
            EditorBounds = b;
        }
        ...
        private void RoundDetectionBoundsSize()
        {
            Vector3 s = new Vector3(
                Mathf.Round(m_EditorBounds.size.x / m_CellSize), Mathf.Round(m_EditorBounds.size.y / m_CellSize),
                0);
            s = Vector3.Max(s, Vector3.one);
            m_NumCells.x = (int)s.x;
            m_NumCells.y = (int)s.y;
            m_NumCells.z = 1;

            s *= m_CellSize;
            s.z = Mathf.Max(m_EditorBounds.size.z, 1);
            m_DetectionBounds.size = s;
            m_DetectionSize = s;

            UpdateGridSize(m_NumCells.x, m_NumCells.y);
        }
