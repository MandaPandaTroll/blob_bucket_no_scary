...
public class Smeller_Blyb : MonoBehaviour
{
                ...
                for(int i = 0; i < smellCircleResults.Length;i++)
                    {
                        ...
                        if(smellCircleResults[i].gameObject.tag == "Predator2" && nMate < 15){
                        ...
                        if(smellCircleResults[i].gameObject.tag == "Predator" && nCompetitor < 15){
