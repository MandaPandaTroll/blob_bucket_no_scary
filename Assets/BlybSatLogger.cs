...
public class BlybSatLogger : MonoBehaviour
{
        ...
        if (time >= sampleRate)
        {
            ...
            if(blybs.Length >= 1)
            {
                ...
                {                                          
                    ...
                    BlybGenome sampledGenome = blybs[sampler].GetComponent<BlybGenome>();
                    string[] nucleotides = new string[27];
                    string[] bases = new string[sampledGenome.extA.GetLength(1)];
                    unitName.Add(sampledBlyb.gameObject.name);
                    for(int a = 0; a < 27; a++)
                    {
                        nucleotides[a] = sampledBlyb.superSatellite[0,a];
                    }
                    ...
                    for(int b = 0; b < 27; b++)
                    {
                        nucleotides[b] = sampledBlyb.superSatellite[1,b];
                    }
                    ...
                    for(int c = 0; c < 27; c++)
                    {
                        nucleotides[c] = sampledBlyb.superSatellite[2,c];
                    }
                    ...
                    for(int d = 0; d < 27; d++)
                    {
                        nucleotides[d] = sampledBlyb.superSatellite[3,d];
                    }
